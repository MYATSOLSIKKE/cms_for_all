<?php  include "includes/db.php"; ?>
 ...
 ?>
  ...
  <?php  } else { ?>
        ...
        <div class="row">
            <p class="pull-right login-to-post">You need to <a href="/NewCMS/login.php">Login</a> to like </p>
        </div>
    ...
    <?php }  ?>
      ...
      <div class="row">
          <p style="font-size:20px" class="pull-right likes">Like: <?php echo getPostLikes($the_post_id);?> </p>
      </div>
...
<?php include "includes/footer.php";?>
        ...
        <script>
            $(document).ready(function(){
                ...
                $('.like').click(function(){
                    $.ajax({
                        url: "/NewCMS/post.php?p_id=<?php echo $the_post_id; ?>",
                        type: 'post',
                        data: {
                            'liked': 1,
                            'post_id': post_id,
